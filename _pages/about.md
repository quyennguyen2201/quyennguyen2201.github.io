...
`Data science` is my passion. I am aspired to apply machine learning algorithm and data analytic techniques in the decision making process. Recently, I developed my interest in geospatial modelling as I am enthusiastic about using satellite images, rasters, and shapes to study the evoluation of the Earth's system. I also tried `Large Language Models` to automate the analysis of climate risk disclosures. Outside of my work, I learnt to write codes and build algorithms from scratch.  
